...
const LoginPage = (props: Props) => {
  ...
  function handleLoginSubmit(values: z.infer<typeof signupFormSchema>) {
    console.log(values)
  }
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleLoginSubmit)}>
              <>
                ...
                <h6 className='pt-2 text-right cursor-pointer text-smallSize font-ba_normal text-baPrimary dark:text-baLight hover:font-ba_medium transition-all transform duration-300 hover:underline'>Forgot Password?</h6>
              </>
