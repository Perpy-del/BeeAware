...
const WelcomeSection = (props: Props) => {
  return (
      <div
        className="flex items-center gap-20 pb-24 px-20 text-baBody dark:text-baLight"
      >
        <div className="w-[35%]">
          <Image
            width={480}
        ...
        <div className="w-[60%] space-y-6">
          ...
          <p className="text-headerFive">
            ...
            discover nearby STI testing locations for proactive health
            management.
          </p>
          <motion.div
            initial="offscreen"
          ...
          >
            <div className="flex flex-col">
              <motion.h1
                ...
                className="text-headerTwo text-baSecondary font-ba_large leading-10"
              >
                3K+
              </motion.h1>
              <motion.span
                variants={countOneVariants}
                className="text-baDark dark:text-baLight text-smallSize"
              >
                HAPPY CLIENTS
              </motion.span>
            </div>
