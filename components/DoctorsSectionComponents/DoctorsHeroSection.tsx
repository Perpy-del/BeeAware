...
const DoctorsHeroSection = (props: Props) => {
  return (
    <div className="sm:mx-5 sm:mb-14 lg:mb-24 lg:mx-20 3xl:mx-40 bg-baAccent rounded-[20px] sm:py-8 sm:px-4 lg:py-10 xl:py-16 lg:px-12 xl:px-16 flex sm:flex-col md:flex-row lg:items-center sm:gap-12 lg:gap-3 xl:gap-0">
