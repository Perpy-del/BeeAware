...
import { SendHorizontal, EllipsisVertical, Trash2, ChevronLeft } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      <div className="pt-5 w-full" onClick={() => setShowMessages(true)}>
        ...
        <div className="flex items-center gap-3 bg-baAccent dark:bg-baSubtle cursor-pointer transition-all transform hover:scale-105 duration-300 p-3 rounded-sm">
          ...
          <div>
            ...
            <span className="block text-baBody sm:text-[10px] md:text-bodySize">Quick Doctor Consultation</span>
          </div>
          <DropdownMenu>
