...
const FormLocationComponent = (props: ConsultFormProps) => {
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center rounded-[20px] border border-input dark:bg-baBody pr-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 h-14">
        <input
          type="text"
          name="location"
          id="location"
